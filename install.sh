...
echo -e "  ${BLUE}•${NC} solana-mev-skill   → ${CYAN}$MEV_SKILL_PATH${NC}"
...
echo -e "  ${GREEN}✓${NC} Installed to $MEV_SKILL_PATH"
...
echo -e "  ${GREEN}✓${NC} solana-mev-skill   ${CYAN}$MEV_SKILL_PATH${NC}"
